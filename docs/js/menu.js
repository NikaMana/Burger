...
window.onload = function () {
  ...
  blockList.addEventListener('click', function (e) {
    e.preventDefault()
    if (e.target.className === 'menu-acco__trigger') {
  ...
  ymaps.ready(function () {
    var myMap = new ymaps.Map('map', {
      ...
      myPlacemark = new ymaps.Placemark(myMap.getCenter([59.896152, 30.424465]), {
    ...
    myPlacemark2 = new ymaps.Placemark(myMap.getCenter([59.891295, 30.316907]), {
  ...
  let span = document.querySelectorAll('.rewiews__button')
  let close =
    Array.from(span).map(elem => {
